...
echo "Creating python Electrum-XPM.app and .dmg"
sudo hdiutil create -fs HFS+ -volname "Electrum XPM" -srcfolder "dist/Electrum XPM.app" dist/electrum-xpm-$VERSION-macosx-beta.dmg
